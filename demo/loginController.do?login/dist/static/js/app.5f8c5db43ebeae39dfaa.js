...
webpackJsonp([0], [,, function (t, e, r) {
  ...
  var n = r(1),
      ...
      s = r.n(i),
      l = r(13),
      c = r.n(l);n.a.use(a.a), e.a = new a.a({ routes: [{ path: "/", name: "Hello", component: s.a }, { path: "/world", name: "World", component: c.a }] });
}, function (t, e, r) {
  function n(t) {
    r(9);
  ...
  Object.defineProperty(e, "__esModule", { value: !0 });var n = r(1),
      a = r(3),
      i = r.n(a),
      s = r(2);n.a.config.productionTip = !1, new n.a({ el: "#app", router: s.a, template: "<App/>", components: { App: i.a } });
}, function (t, e, r) {
  "use strict";
  ...
  t.exports = { render: function render() {
      var t = this,
          e = t.$createElement,
          n = t._self._c || e;return n("div", { attrs: { id: "app" } }, [n("img", { attrs: { src: r(11) } }), t._v("\n  nciuhewfhiwehfiewh\n  "), n("router-link", { attrs: { to: "/" } }, [t._v("首页")]), t._v(" "), n("router-link", { attrs: { to: "/world" } }, [t._v("go world")]), t._v(" "), n("router-view")], 1);
    }, staticRenderFns: [] };
}, function (t, e) {
  t.exports = { render: function render() {
      var t = this,
...
//# sourceMappingURL=app.5f8c5db43ebeae39dfaa.js.map
//# sourceMappingURL=app.5f8c5db43ebeae39dfaa.js.map